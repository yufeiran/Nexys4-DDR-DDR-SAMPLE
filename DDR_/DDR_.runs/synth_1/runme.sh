...
HD_PWD='D:/codehub/VIVADO/DDR_/DDR_.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log looper1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source looper1_1.tcl
