...
HD_PWD='D:/codehub/VIVADO/DDR_/DDR_.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log looper1_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source looper1_1.tcl -notrace
